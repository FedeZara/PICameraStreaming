...
\input{namespaceclient__app}
\chapter{Documentazione delle classi}
\input{classclient__app_1_1_buffer_image}
\input{classclient__app_1_1_i_p_m_a_c_mapper_1_1_i_p_and_mac}
\input{classclient__app_1_1_i_p_m_a_c_mapper}
\input{classclient__app_1_1_main_window}
\input{classclient__app_1_1_pi_image}
\input{classclient__app_1_1_window_m_a_c}
\chapter{Documentazione dei file}
\input{_i_p_m_a_c_mapper_8cs}
\input{_main_window_8xaml_8cs}
\input{_pi_image_8cs}
\input{_window_m_a_c_8xaml_8cs}
